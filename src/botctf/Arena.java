...
public class Arena implements Runnable {
	...
	static {
		bots[0] = new Player("java NavPointBot",2, 2, Bot.blueTeam);
		bots[1] = new Player("java NavPointBot",3, 3, Bot.blueTeam);
//		bots[2] = new Player("java NavPointBot",62, 62, Bot.redTeam);
//		bots[3] = new Player("java NavPointBot",61, 61, Bot.redTeam);
		bots[2] = new Player("java NavPointBot",4, 4, Bot.blueTeam);
		bots[3] = new Player("java NavPointBot",5, 5, Bot.blueTeam);
		bots[4] = new Player("java NavPointBot",6, 6, Bot.blueTeam);
		bots[5] = new PathFinderOptimised(62, 62, Bot.redTeam);
		bots[6] = new PathFinderOptimised(61, 61, Bot.redTeam);
		bots[7] = new PathFinderOptimised(60, 60, Bot.redTeam);
		bots[8] = new PathFinderOptimised(59, 59, Bot.redTeam);
		bots[9] = new PathFinderOptimised(58, 58, Bot.redTeam);
		for (Bot b : bots) {
	...
	public void run() {
		...
		{
			Thread.sleep(1000);
			ImageOutputStream os = new FileImageOutputStream(new File("botctf.gif"));
			GifSequenceWriter gif = new GifSequenceWriter(os, gamePanel.updateImage().getType(), 80, true);
							...
							switch (m.moveType) {
								case Move:
									if (Bot.map[adjX][adjY] == Bot.space) {
										...
										gif.writeToSequence(gamePanel.updateImage());
										gif.close();
